-- ============================================================
-- Calibraciones: separa la fecha "estimada" de salida de mantenimiento
-- (la que ya se registraba desde la creación de la orden) de la fecha
-- "real" que se confirma al terminar esa etapa, más una nota opcional.
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS fecha_salida_mantenimiento_real date;
ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS nota_mantenimiento text;
