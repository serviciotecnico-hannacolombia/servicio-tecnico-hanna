-- ============================================================
-- Calibraciones: agrega la fecha de llegada del metrólogo(a) — único
-- campo que ahora se pide al avanzar de "Visita programada" a
-- "En calibración" en el flujo de sitio (in situ / sede Hanna Dorado).
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS fecha_llegada_metrologo date;
