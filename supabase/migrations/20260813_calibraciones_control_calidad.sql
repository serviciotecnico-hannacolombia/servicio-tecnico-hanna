-- ============================================================
-- Calibraciones: agrega la fecha y las notas propias de la etapa
-- "Control de calidad" — antes esta etapa reutilizaba campos de cierre
-- (entrega de certificado, cartas) que ahora se simplifican a solo estos
-- dos. Se incorporan a la auditoría de cambios igual que el resto.
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS fecha_control_calidad date;
ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS notas_control_calidad text;
