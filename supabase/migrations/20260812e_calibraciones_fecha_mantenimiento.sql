-- ============================================================
-- Calibraciones: agrega fecha_salida_mantenimiento — la fecha en la
-- que el equipo sale de mantenimiento/reparación antes de continuar
-- con el proceso de calibración (bloque "Siguiente paso" en Fechas
-- del proceso) — y la incorpora a la auditoría de cambios.
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS fecha_salida_mantenimiento date;
