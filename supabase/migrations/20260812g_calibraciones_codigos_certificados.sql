-- ============================================================
-- Calibraciones: agrega "códigos de certificados" a la orden — texto
-- libre donde se listan, separados por coma, los códigos de certificado
-- que aplican a esa orden (puede tener más de uno). Se incorpora a la
-- auditoría de cambios igual que el resto de columnas de texto.
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS codigos_certificados text;
