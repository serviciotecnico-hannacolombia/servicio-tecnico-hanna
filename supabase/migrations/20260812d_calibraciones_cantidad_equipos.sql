-- ============================================================
-- Calibraciones: agrega "cantidad de equipos" a la orden (cuántos
-- equipos cubre) y lo incorpora a la auditoría de cambios.
-- ============================================================

ALTER TABLE ordenes_calibracion ADD COLUMN IF NOT EXISTS cantidad_equipos integer;
