...
export function VistaMantenimiento({ form, set, setForm, puedeEditar, asesores, asesorSeleccionado, saving, onTerminar }: {
  ...
  return (
    <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: 24 }}>
      <div style={{
        ...
        <Wrench size={16} /> Equipo en mantenimiento y reparación — solo se muestran los datos relevantes para esta etapa.
      </div>
